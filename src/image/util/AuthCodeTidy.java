 ...
 * @Description: <br>
 * <br>
 *               下面通过一个案例具体分析验证码的制作及控制浏览器的缓存
 * @Created on 2014-1-8 上午11:57:13
 * @author 杨凯
 */
public class AuthCodeTidy extends HttpServlet {

    private static final long serialVersionUID = 1L;

    private static final int WIDTH = 130, HEIGHT = 35;

    Random ran = new Random();

    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {

        BufferedImage image = new BufferedImage(WIDTH, HEIGHT, BufferedImage.TYPE_INT_RGB); // 1.创建图片
        Graphics g = image.getGraphics(); // 2.得到图片
